...
from insurance_premium_prediction_project.schema.user_input import UserInput
from insurance_premium_prediction_project.ml_model.predict import MODEL_VERSION,model,predict_ouptut
...
def predict(data:UserInput):
    ...
    # if a ==6:
    #     return JSONResponse(status_code=200,content={'message':'Habibi'})
    if model is None:
